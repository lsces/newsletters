...
<ul class="{$packageMenuClass}">
	<li><a class="item" href="{$smarty.const.NEWSLETTERS_PKG_URL}index.php">{biticon ipackage="icons" iname="text-x-generic" iexplain="List Newsletters" ilocation=menu}</a></li>
	{if $gBitUser->hasPermission( 'p_newsletters_create' )}
		<li><a class="item" href="{$smarty.const.NEWSLETTERS_PKG_URL}newsletters.php?new=1">{biticon ipackage="icons" iname="text-x-generic" iexplain="Create Newsletter" ilocation=menu}</a></li>
	{/if}
