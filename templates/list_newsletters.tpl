				...
				{foreach key=nlId from=$newsletters item=nl}
					<tr class="{cycle values='odd,even'}">
						...
						<td style="text-align:right;">
							<a href="{$smarty.const.NEWSLETTERS_PKG_URL}edition_edit.php?nl_id={$nl.nl_id}">{biticon ipackage="icons" iname="view-list-text" ipackage="icons" iexplain="New Edition"}</a>
							<a href="{$smarty.const.NEWSLETTERS_PKG_URL}newsletters.php?remove=1&amp;nl_id={$nl.nl_id}">{biticon ipackage="icons" iname="user-trash" ipackage="icons" iexplain=Remove}</a>
							<a href="{$smarty.const.NEWSLETTERS_PKG_URL}newsletters.php?&amp;nl_id={$nl.nl_id}">{biticon ipackage="icons" iname="edit" ipackage="icons" iexplain=Edit}</a>
						</td>
					</tr>
				{foreachelse}
					<tr class="norecords">
